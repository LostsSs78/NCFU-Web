    ...
    Prism = function (o) {
      ...
      j = {
          ...
          clone: function n(e, a) {
            ...
            switch (a = a || {
              ...
              case 'Object':
                ...
                for (var s in r = {}, a[t] = r, e) e.hasOwnProperty(s) &&
                (r[s] = n(e[s], a));
                return r;
              case 'Array':
        ...
        languages: {
          ...
          insertBefore: function (n, e, t, a) {
            ...
            for (r in s) if (s.hasOwnProperty(r)) {
              if (r == e) for (var l in t) t.hasOwnProperty(l) &&
              (i[l] = t[l]);
              t.hasOwnProperty(r) ||
              (i[r] = s[r])
            }
          ...
          DFS: function e(t, n, a, r) {
            ...
            l,
            o = j.util.objId;
            for (s in t) t.hasOwnProperty(s) &&
            (
              n.call(t, s, t[s], a || s),
              i = t[s],
              'Object' !== (l = j.util.type(i)) ||
              r[o(i)] ? 'Array' !== l ||
              r[o(i)] ||
              (r[o(i)] = !0, e(i, n, s, r)) : (r[o(i)] = !0, e(i, n, null, r))
            )
          }
        },
        plugins: {
        ...
        highlight: function (e, t, n) {
          ...
          if (j.hooks.run('before-tokenize', e), e.grammar) return e.tokens = j.tokenize(e.code, e.grammar),
          ...
          for (
            ...
            s = (
              ...
              !function e(t, n, a, r, s, i) {
                for (var l in a) if (a.hasOwnProperty(l) && a[l]) {
                  var o = a[l];
                  o = Array.isArray(o) ? o : [
                    o
                  ];
                    ...
                    for (
                      ...
                      if (!(v instanceof C)) {
                        ...
                        if (m) {
                          ...
                          A = y;
                          for (A += b.value.length; A <= k; ) b = b.next,
                          A += b.value.length;
                          if (A -= b.value.length, y = A, b.value instanceof C) continue;
                          for (var P = b; P !== n.tail && (A < w || 'string' == typeof P.value); P = P.next) x++,
                          A += P.value.length;
                          x--,
                          v = t.slice(y, A),
                          F.index -= y
      ...
      if (
        ...
        C.stringify = function t(e, n) {
          ...
          i = (
            e &&
            (
              Array.isArray(e) ? Array.prototype.push.apply(s.classes, e) : s.classes.push(e)
            ),
            j.hooks.run('wrap', s),
            ''
          );
      ...
      (
        ...
        o.addEventListener(
          ...
          function (e) {
            ...
            n = e.code,
            e = e.immediateClose;
            o.postMessage(j.highlight(n, j.languages[t], t)),
            e &&
            o.close()
          },
          !1
      ...
      (
        ...
        'interactive' === a &&
        e &&
        e.defer ? document.addEventListener('DOMContentLoaded', r) : window.requestAnimationFrame ? window.requestAnimationFrame(r) : window.setTimeout(r, 16)
      ),
      j
    }(_self);
        ...
        Prism.hooks.add(
          ...
          function (e) {
            ...
            (
              e.code = '',
              l.setAttribute(u, g),
              (r = l.appendChild(document.createElement('CODE'))).textContent = 'Loading…',
              ...
              a = function (e) {
                ...
                a = function (e) {
                  var t,
                  n;
                  if (e = /^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(e || '')) return t = Number(e[1]),
                  n = e[2],
                  e = e[3],
                  n ? e ? [
                    t,
                ...
                (
                  ...
                  l.setAttribute('data-start', String(n + 1))
                ),
                r.textContent = e,
                Prism.highlightElement(r)
              },
              s = function (e) {
                l.setAttribute(u, 'failed'),
                r.textContent = e
              },
              ...
              i.onreadystatechange = function () {
                ...
                (
                  i.status < 400 &&
                  i.responseText ? a(i.responseText) : 400 <= i.status ? s('✖ Error ' + i.status + ' while fetching file: ' + i.statusText) : s('✖ Error: File does not exist or is empty')
                )
              },
              i.send(null)
            )
